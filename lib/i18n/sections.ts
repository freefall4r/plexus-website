...
export const sectionCopy = {
  ...
  work: {
    en: {
      ...
      items: [
        { name: "Wave Hangers", material: "Carved solid pine & walnut" },
        { name: "Arc Bench", material: "Lacquered ash" },
        { name: "Live-edge Table", material: "Oak & river stone" },
        { name: "Relief Panel", material: "Carved walnut & stone" },
    ...
    ar: {
      ...
      items: [
        { name: "علّاقات مموّجة", material: "صنوبر وجوز صلب منحوت" },
        { name: "مقعد القوس", material: "خشب دردار مطلي" },
        { name: "طاولة بحافة طبيعية", material: "بلوط وحجر نهري" },
        { name: "لوح نحتي", material: "جوز منحوت وحجر" },
